...
const QuestionsDetails = () => {
  ...
  const url = "https://ai-quest.netlify.app/";
          ...
          {questionsList.data
            ...
            .map((question) => (
              <div key={question._id}>
                ...
                <section className="ai-generated-answer">
                  <h3>AI Generated Answer:</h3>
                  <button className="AI" onClick={handleAI}>Generate Answer</button>
                  {showAI && (
                    <div>
                      {questionsList.data
                        .filter((question) => question._id === id)
